...
const OurGoalsCard = ( { item } ) => {
    console.log( item );

    return (
        <>
            <div className='bg-absolute-white rounded-[10px] 2xl:rounded-xl p-[30px] lg:p-10 2xl:p-[50px] w-full lg:max-w-[calc((100%-20px)/2)] 2xl:max-w-[calc((100%-30px)/2)]'>
