...
const Button = ( { text, variation = "secondary", size = "small", className, onClick } ) => {
  const btn_classes = {
    primary:
  ...
  return (
    <button onClick={onClick} className={`${ btn_classes[ variation ] } ${ btn_sizes[ size ] } rounded-lg capitalize  flex items-center justify-center font-medium ${ className }`}>
      {variation === "icon" ? (
